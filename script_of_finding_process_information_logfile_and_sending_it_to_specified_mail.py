...
def MailSender(filename,time):
	try:
		fromaddr = "parittushar.1503@gmail.com"
		toaddr = "omkarchavan3414@gmail.com"
		...
		Subject = """Marvellous Infosystem Process Log generaed at : %s
		  """%(time)
...
def ProcessLog(log_dir = 'marvellous'):
	...
	if connected:
		...
		print("there is no nternet connection ")

def main():
	print ("script by Tushar Parit ")

	print ("Application name : Process information log file sending by mail")
	...
	if (argv[1] == "-u") or (argv[1] == "-U"):
		print ("Usage : process information log file sending by mail")
		exit()
